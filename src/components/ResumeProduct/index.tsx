...
import { deleteOrder, editOrder } from '../../store/slices/quioscoslice'

const ResumeProduct = (product: Order) => {
  ...
  return (
    <div className='shadow p-5 mb-3 flex gap-10 items-center'>
      ...
      <div>
        <button
          onClick={() => dispatch(editOrder(product.id))}
        ...
        <button
          ...
          className='bg-red-700 flex items-center gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full mt-3'
          type='button'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
